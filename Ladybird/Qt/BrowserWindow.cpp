    ...
    , m_webdriver_content_ipc_path(webdriver_content_ipc_path)
{
    ...
    QObject::connect(about_action, &QAction::triggered, this, [this] {
        new_tab_from_url(ak_url_from_qstring("about:version"), Web::HTML::ActivateTab::Yes);
    });
...
Tab& BrowserWindow::create_new_tab(Web::HTML::ActivateTab activate_tab)
{
    ...
    tab->view().on_new_web_view = [this](auto activate_tab, Web::HTML::WebViewHints, Optional<u64>) {
        auto& tab = new_tab_from_url(AK::URL("about:blank"sv), activate_tab);
